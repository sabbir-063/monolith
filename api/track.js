...
export default async function handler(req, res) {
  ...
  try {
    ...
    const tabName = "User Behaviour Tracking";
    ...
    try {
      ...
      console.error("[tracker] Google Sheets metadata check or sheet tab auto-creation failed:", metaErr);
    }
    ...
    console.error("[tracker] Handler encountered error:", error);
